                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <Input
                                ...
                                className={`!bg-techDark text-center tracking-widest font-bold text-xs !py-3 transition-all duration-300 ${error && !name ? '!border-red-600' : 'focus:!border-electricBlue'}`}
                            />
                            ...
                            <Input
                                ...
                                className={`!bg-techDark text-center tracking-widest font-mono text-lg !py-4 transition-all duration-300 ${error && password ? '!border-red-600 !text-red-500 placeholder-red-900/50' : 'focus:!border-electricBlue'}`}
                            />
                        </div>
