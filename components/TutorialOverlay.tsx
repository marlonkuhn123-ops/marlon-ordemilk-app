    ...
    const steps: TutorialStep[] = [
        {
            ...
            title: "BEM-VINDO AO ORDEMILK TECH V72",
        ...
        },
        {
            ...
            content: (
                <>
                    <p>A ferramenta mais importante para garantir o compressor. Calcule o <strong>Sup.Aque</strong> (superaquecimento) e o <strong>Sub.Res</strong> (sub-resfriamento).</p>
        ...
        },
        {
            ...
            content: (
                <>
                    <p>Você está pronto para usar o <strong>Ordemilk Tech V72</strong>.</p>
